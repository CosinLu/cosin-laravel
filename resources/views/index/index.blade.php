                    ...
                    <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="username">{{Session::get('username')}}</span>
                            </div>
                        </div>

                        <div class="profile-info-row">
                            <div class="profile-info-name"> PHP-Version </div>

                            <div class="profile-info-value">
                                <i class="icon-map-marker light-orange bigger-110"></i>
                                <span class="editable" id="country">{{PHP_VERSION}}</span>
                            </div>
                        </div>

                        <div class="profile-info-row">
                            <div class="profile-info-name"> ZEND_Version </div>

                            <div class="profile-info-value">
                                <span class="editable" id="age">{{zend_version()}}</span>
                            </div>
                        </div>

                        <div class="profile-info-row">
                            <div class="profile-info-name"> MYSQL支持 </div>

                            <div class="profile-info-value">
                                <span class="editable" id="signup">{{function_exists ('mysql_close')? "是" : "否"}}</span>
                            </div>
                        </div>

                        <div class="profile-info-row">
                            <div class="profile-info-name">数据库持续连接</div>

                            <div class="profile-info-value">
                                <span class="editable" id="login">{{ @get_cfg_var("mysql.allow_persistent")?"是 ":"否"}}</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="about">{{PHP_OS}}</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="about">{{mysqli_get_client_info()}}</span>
                            </div>
                        </div>
                    </div>
